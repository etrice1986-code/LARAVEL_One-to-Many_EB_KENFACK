        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="text-center mb-4">
                    <h1 class="display-6 fw-bold text-dark mb-1">Scrivi un Nuovo Articolo</h1>
                    ...
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="form-text text-muted small">Carica un file JPG, PNG o WEBP (Max 2MB). Se lasciato vuoto, verrà usata una copertina predefinita.</div>
                            ...
                            <div class="d-grid gap-2 mt-4">
                                <button type="submit" class="btn btn-success btn-lg rounded-3 shadow-sm fw-semibold">
                                    <i class="bi bi-send-check-fill me-2"></i>Pubblica l'Articolo
                                </button>
                                <a href="{{ route('article.index') }}" class="btn btn-link btn-sm text-secondary text-decoration-none">
